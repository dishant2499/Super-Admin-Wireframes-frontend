...
const Program = ()=>  {
 ...
 const ProgramData1 = (data) =>{
    ...
    return (
        ...
        <Button icon={<PlusOutlined />} size={"middle "} style={{backgroundColor:'black',color:'white',borderRadius:'5px'}}
                onClick={() => setModal2Open(true)}>
           Create Program
        </Button>
            <Button type="text" icon={<FilterOutlined />} size={"middle "} >z
                filter
            </Button>
        </div>
        <div style={{
            ...
            <Modal
                ...
                footer={[
                    ...
                    <Button  onClick={() => setModal2Open(false)} style={{
            ...
            >
                ...
                <Input placeholder="Health insurance platinum" style={{margin:'10px'}} onChange={ProgramData}/>
                <Select
